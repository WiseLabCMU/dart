...
pred = dataset.load_arrays("results/cabinets_sim_pred.mat")
...
for idx, (ax1, ax2, ax3) in zip(np.arange(8) * 600, axs.reshape(-1, 3)):
...
fig.savefig("results/cabinets_sim_pred_ex.png")
